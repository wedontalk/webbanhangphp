            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-xl">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="text-muted float-end">News</small>
                    </div>
                    <div class="card-body">
                        <form action="addnews.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="slug" name="name_news" placeholder="Nhập Name Danh Mục" onkeyup="ChangeToSlug()">
                                </div>
                            </div>
                            <!-- end name -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                <textarea id="short_description" class="form-control" name="short_description" placeholder="Nhập Mô tả !!!"></textarea>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="basic-icon-default-message">ConTent</label>
                                <div class="input-group input-group-merge">
                                <textarea id="content" class="form-control" name="content" placeholder="Nhập Thông tin chính"></textarea>
                                </div>
                            </div>
                            <div class="mb-3">
