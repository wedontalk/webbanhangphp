<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        $submitproduct = $class->create($data);
    }
                    ...
                    <div class="card-body">
                        <form action="addproduct.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="slug" name="name" placeholder="Nhập Name Danh Mục" onkeyup="ChangeToSlug()">
                                </div>
                            </div>
                            <!-- end name -->
                            <div class="mb-3">
                                ...
                                <input type="text" id="convert_slug" class="form-control" name="slug" placeholder="Đường Dẫn Danh Mục" readonly>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="price" class="form-control" placeholder="100.000" name="price">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text">$</span>
                                    <input type="number" class="form-control" placeholder="80.000" name="price_discount">
                                    <span class="input-group-text">VNĐ</span>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <textarea id="editor" class="form-control" name="description" placeholder="Nhập Mô tả danh mục nếu có !!!"></textarea>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i class='bx bx-rename'></i></span>
                                <input type="text" class="form-control" name="length" placeholder="Nhập Số Lượng Sản Phẩm">
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i class='bx bx-rename'></i></span>
                                <input type="text" class="form-control" name="width" placeholder="Nhập Số Lượng Sản Phẩm">
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i class='bx bx-rename'></i></span>
                                <input type="text" class="form-control" name="height" placeholder="Nhập Số Lượng Sản Phẩm">
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i class='bx bx-rename'></i></span>
                                <input type="text" class="form-control" name="weight" placeholder="Nhập Số Lượng Sản Phẩm">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="basic-icon-default-fullname">Màu Sắc (*)</label>
                                <div class="input-group input-group-merge">
                                <input type="text" class="form-control" name="color[]" placeholder="Nhập màu sắc" data-role="tagsinput">
                                </div>
                            </div>
                            <div class="mb-3">
...
<!-- <script>
    ...
    var numVND = new Intl.NumberFormat("en-US",{
        style:"currency",
        currency:"USD"
    })
    this.value = numVND.format(this.value);
    });
</script> -->