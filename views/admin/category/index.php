<?php
    ...
    $showpaginate = $class->category_list($start_index, $per_page);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($value['action'] == 1):?>
                                                <span class="badge bg-label-primary me-1">Danh Mục Hiện</span>
                                            <?php elseif($value['action'] == 2):?>
                                                <span class="badge bg-label-warning me-1">Danh Mục Ẩn</span>
                                            <?php endif;?>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                <a class="dropdown-item" href="editcategory.php?cateid=<?=$value['id']?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
